...
export default function AquariumPanel() {
  ...
  // One rAF tick — lets background image start loading before JS animates
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 1 }}>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "160px", background: "linear-gradient(to bottom,transparent,#050402)", zIndex: 3 }} />
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "80px", background: "linear-gradient(to bottom,rgba(5,4,2,0.6),transparent)", zIndex: 3 }} />
      </div>

      {/* ── CSS light rays — pure CSS, no JS ── */}
      <div className="aqua-rays-wrap" style={{ position: "absolute", inset: 0, zIndex: 2, pointerEvents: "none", overflow: "hidden" }}>
        {[0, 1, 2, 3].map(i => (
          <div key={i} className={`aqua-ray aqua-ray-${i}`} style={{
            position: "absolute", top: 0, left: `${15 + i * 20}%`,
            width: "1px", height: "65%",
      ...
      <div className="aqua-grid" style={{
        ...
        <div className="aqua-thumb-col" style={{ display: "flex", flexDirection: "column", gap: 0, alignSelf: "center" }}>
          <div style={{
            ...
            />
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(0,13,15,0.15) 0%, rgba(0,13,15,0.65) 100%)" }} />
            <div style={{ position: "absolute", bottom: "1rem", left: "1rem", zIndex: 2 }}>
              <div style={{ color: "#C9A84C", fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", fontFamily: "var(--font-montserrat)", lineHeight: 1 }}>Shark Tunnel</div>
              <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.58rem", fontFamily: "var(--font-montserrat)", marginTop: "0.2rem" }}>Walk beneath the ocean</div>
            </div>
            <div style={{ position: "absolute", bottom: "8px", left: "8px", width: "14px", height: "14px", borderBottom: "1px solid rgba(201,168,76,0.5)", borderLeft: "1px solid rgba(201,168,76,0.5)" }} />
          </div>

          <div style={{ borderTop: "1px solid rgba(0,180,220,0.15)", paddingTop: "0.7rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ color: "rgba(0,180,220,0.45)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", fontFamily: "var(--font-montserrat)", fontWeight: 600 }}>Sea Life Minnesota</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.1rem", maxWidth: "520px" }}>
          ...
          <p style={{
            ...
            textTransform: "uppercase", fontFamily: "var(--font-montserrat)", fontWeight: 700, margin: 0,
          ...
          <h2 style={{
            ...
            fontWeight: 800, fontFamily: "var(--font-montserrat)", margin: 0, lineHeight: 0.95,
          ...
          <h3 style={{
            ...
            fontWeight: 800, fontFamily: "var(--font-montserrat)", margin: 0, lineHeight: 1.1,
          ...
          <div style={{
            ...
            transition: "transform 0.4s ease 0.28s",
          }} />
          ...
          <p style={{
            ...
            opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(16px)",
            transition: "opacity 0.6s ease 0.32s, transform 0.6s cubic-bezier(0.22,1,0.36,1) 0.32s",
          }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.6rem", marginTop: "0.4rem" }}>
            {AQUA_STATS.map((s, i) => (
              <div key={s.value} style={{
                background: "rgba(0,180,220,0.05)", border: "1px solid rgba(0,180,220,0.18)",
                padding: "0.75rem 1rem",
                opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(12px)",
                transition: `opacity 0.5s ease ${0.4 + i * 0.09}s, transform 0.5s cubic-bezier(0.22,1,0.36,1) ${0.4 + i * 0.09}s`,
              }}>
                <div style={{ color: "rgba(0,200,240,0.9)", fontSize: "clamp(1.1rem,2vw,1.5rem)", fontWeight: 800, fontFamily: "var(--font-montserrat)", lineHeight: 1, fontVariantNumeric: "tabular-nums" }}>{s.value}</div>
                <div style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.58rem", letterSpacing: "0.14em", textTransform: "uppercase", fontFamily: "var(--font-montserrat)", fontWeight: 600, marginTop: "0.25rem" }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <style>{`
        ...
        @media (min-width:768px) {
          .aqua-grid { grid-template-columns: 1fr 1fr !important; align-items: center; }
