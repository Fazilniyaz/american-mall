...
if (phase === "splash") {
  return (
    <div style={{
      ...
      {/* ── Slideshow — Next.js Image (auto compress + AVIF) ── */}
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(135deg, rgba(5,4,2,0.82) 0%, rgba(5,4,2,0.62) 50%, rgba(5,4,2,0.82) 100%)",
        zIndex: 1,
      }} />
      ...
      <div style={{ position: "relative", zIndex: 3, textAlign: "center" }}>
        ...
        <svg viewBox="0 0 44 44" width="60" height="60" aria-hidden="true"
          ...
          <circle cx="22" cy="22" r="14" fill="none"
            stroke="url(#splash-g)" strokeWidth="1" opacity="0.6" />
          <polygon points="22,14 30,22 22,30 14,22"
            fill="none" stroke="url(#splash-g)" strokeWidth="1.3" opacity="0.9" />
          <polygon points="22,17 27,22 22,27 17,22" fill="url(#splash-g)" />
      ...
      <div style={{ position: "fixed", inset: 0, background: "#000", zIndex: 1000 }}>
        ...
        <div style={{
          ...
          <svg viewBox="0 0 44 44" width="32" height="32">
            ...
            <circle cx="22" cy="22" r="14" fill="none" stroke="url(#vid-g)" strokeWidth="1" opacity="0.6" />
            <polygon points="22,14 30,22 22,30 14,22" fill="none" stroke="url(#vid-g)" strokeWidth="1.3" />
            <polygon points="22,17 27,22 22,27 17,22" fill="url(#vid-g)" />
          </svg>
        </div>
        ...
        <div style={{
          ...
          zIndex: 10, display: "flex", flexDirection: "column", gap: "0.6rem",
          alignItems: "flex-end",
        }}>
          <button
            onClick={() => {
  ...
  if (phase === "hub") {
    return (
      <div style={{
        ...
        <div style={{
          position: "absolute", inset: 0,
          background: "linear-gradient(135deg, rgba(5,4,2,0.92) 0%, rgba(5,4,2,0.75) 60%, rgba(5,4,2,0.88) 100%)",
          zIndex: 1,
        }} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <svg viewBox="0 0 44 44" width="52" height="52">
              ...
              <circle cx="22" cy="22" r="14" fill="none" stroke="url(#hub-g)" strokeWidth="1" opacity="0.6" />
              <polygon points="22,14 30,22 22,30 14,22" fill="none" stroke="url(#hub-g)" strokeWidth="1.3" opacity="0.9" />
            ...
            <div>
              ...
              <h1 style={{
                ...
                lineHeight: 1.0,
                margin: "0 0 0.3rem",
              }}>Mall of<br />America</h1>
              <p style={{
                color: "rgba(201,168,76,0.55)", fontSize: "0.65rem",
            ...
            <div style={{ display: "flex", gap: "2rem", marginTop: "0.5rem", flexWrap: "wrap" }}>
              {[
                ...
                <div key={s.label}>
                  <div style={{
                    color: "#C9A84C", fontSize: "clamp(1.2rem,2vw,1.5rem)",
                    fontWeight: 800, fontFamily: "var(--font-montserrat)", lineHeight: 1,
                  }}>{s.val}</div>
                  <div style={{
                    color: "rgba(255,255,255,0.3)", fontSize: "0.58rem",
                    letterSpacing: "0.14em", textTransform: "uppercase",
                    fontFamily: "var(--font-montserrat)", fontWeight: 600, marginTop: "0.2rem",
                  }}>{s.label}</div>
                </div>
              ))}
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
            ...
            {SLIDES.map((slide, i) => (
              ...
              >
                <span className="hub-num" style={{
                  color: "rgba(201,168,76,0.4)", fontSize: "0.6rem",
                ...
                <span className="hub-label" style={{
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#050402", overflow: "hidden", zIndex: 0 }}>
        ...
        <div style={{ pointerEvents: "all", display: "flex", gap: "0.5rem" }}>
          <button
            ...
            style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "0.9rem", cursor: current === 0 ? "default" : "pointer",
              transition: "all 0.2s ease",
            }}
          ...
          <button
            ...
            style={{
              background: "none", border: "1px solid rgba(201,168,76,0.25)",
              color: current === SLIDES.length - 1 ? "rgba(201,168,76,0.2)" : "#C9A84C",
              width: "32px", height: "32px",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "0.9rem",
      ...
      <nav style={{
        ...
        <div style={{
          display: "flex", flexDirection: "column",
          alignItems: "flex-end", marginBottom: "1.2rem", gap: "2px",
        }}>
          <span style={{
            color: "#C9A84C", fontSize: "0.55rem", fontWeight: 800,
            letterSpacing: "0.3em", textTransform: "uppercase",
            fontFamily: "var(--font-montserrat)", lineHeight: 1,
          }}>{SLIDES[current]?.chapter}</span>
          <span style={{
            color: "rgba(255,255,255,0.18)", fontSize: "0.5rem", fontWeight: 600,
        ...
        <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
          ...
          <div style={{
            ...
            width: "1px", background: "rgba(201,168,76,0.12)", zIndex: 0,
          }} />
          {/* Progress fill */}
          <div style={{
      ...
      {menuOpen && (
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0", width: "clamp(280px,50vw,480px)" }}>
            <p style={{
              color: "rgba(255,255,255,0.22)", fontSize: "0.58rem",
              letterSpacing: "0.35em", textTransform: "uppercase",
              fontFamily: "var(--font-montserrat)", fontWeight: 600,
            ...
            {SLIDES.map((slide, i) => (
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.paddingLeft = "0.8rem"; }}
                onMouseLeave={e => { e.currentTarget.style.paddingLeft = "0"; }}
              >
                <span style={{
                  color: current === i ? "#C9A84C" : "rgba(201,168,76,0.35)",
                  fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.2em",
                  fontFamily: "var(--font-montserrat)", width: "26px", flexShrink: 0,
                }}>{slide.chapter}</span>
                <span style={{
                ...
                {current === i && (
                  <span style={{ color: "#C9A84C", fontSize: "0.6rem", marginLeft: "auto" }}>◆</span>
                )}
              </button>
            ))}
            <div style={{ borderTop: "1px solid rgba(201,168,76,0.08)" }} />
            ...
            <button
              ...
              style={{
                ...
                fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.25em",
                textTransform: "uppercase", fontFamily: "var(--font-montserrat)",
